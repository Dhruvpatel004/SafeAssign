...
function classroom() {
  return (
    <>
      ...
      <div class="mt-5 max-w-[700px] p-4 text-left bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
      ...
      <div class="relative mt-5 flex items-center">
        <img
          src={pic}
          alt="Image"
          class="w-16 h-16 object-cover rounded-full overflow-hidden shadow mr-8"
        />

        <div class="w-full p-4 text-left bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
          <p class="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">
            type some thing
          </p>
        </div>
      ...
      <div class="mt-5 w-70 p-4 text-left bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
      ...
      <div class="mt-5 flex items-start gap-2.5">
        <img class="w-8 h-8 rounded-full" src={pic} alt="Bonnie Green image" />
