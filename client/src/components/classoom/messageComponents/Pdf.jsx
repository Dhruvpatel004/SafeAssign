...
function Pdf() {
    ...
    const handleOpenPdf = () => {
        // Replace 'pdfUrl' with the name of your constant variable
        window.open(pdfUrl, '_blank');
      };
  return (
    <div class="flex flex-col w-full max-w-[300px] leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
